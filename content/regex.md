...
```{image} images/updated_greedy.png
:width: 700
:alt: Screenshot of regex 101 highlighting part of the explanation, described more below.
```
...
```{image} images/updated_capturing_groups.png
:width: 700
:alt: ""
```
...
```{image} images/ref_sheet_re_methods.png
:width: 800
:alt: Screenshot of the exam reference sheet showing re.match(), re.search(), re.findall(), and re.sub()
```
