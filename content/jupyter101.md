...
```{image} images/run_all.gif
:width: 500
:alt: "Gif showing exactly where to click to run all cells
```
...
```{image} images/kernel.gif
:width: 500
:alt: Gif showing exactly where to click to access the mostly frequently used kernel options.
```
...
```{image} images/autoclose_brackets.gif
:width: 500
:alt: Gif showing how to toggle autoclose bracket
```
