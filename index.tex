...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, opacityback=0, left=2mm, leftrule=.75mm, toprule=.15mm, colframe=quarto-callout-note-color-frame, colback=white, breakable, arc=.35mm, coltitle=black, titlerule=0mm, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, bottomtitle=1mm, rightrule=.15mm, opacitybacktitle=0.6, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}]
